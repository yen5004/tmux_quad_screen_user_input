...
then
    ...
    tmux new-window -t $SESSION:0 -n $w0 && $sip
       
    # Start new window & log pane
    tmux new-window -t $SESSION:1 -n $w1 && $sip
      
    #Start new window & log pane
    tmux new-window -t $SESSION:2 -n $w2 && $sip
    
    #Start new window & log pane
    tmux new-window -t $SESSION:3 -n $w3 && $sip
    
    #Start new window & log pane
    tmux new-window -t $SESSION:4 -n $w4 && $sip
